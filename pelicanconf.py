...
DESCRIPTION = "Lorem Ipsum something about your site and you too probably."			# EDIT THIS
...
NAVIGATION = [
    ...
    {'site': 'twitter', 'user': '', 'url': 'https://twitter.com/andrewtcrooks'},
    {'site': 'github', 'user': '', 'url': 'https://github.com/andrewtcrooks'},
    {'site': 'linkedin', 'user': '', 'url': 'http://linkedin.com/in/andrewtcrooks'},
    #{'site': 'twitter', 'user': '', 'url': 'http://www.kaggle.com/darkstardata'}
